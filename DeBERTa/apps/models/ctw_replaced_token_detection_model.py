...
from ...deberta import *
from ctw_masked_language_model import LMMaskPredictionHead
...
class CharToWord_ReplacedTokenDetectionModel(NNModule):
  ...
  def forward(self, input_ids, char_input_mask, word_input_mask, char_position_ids=None, word_position_ids=None, labels=None):
    ...
    logits = self.deberta(input_ids, char_input_mask,
    ...
    mask_labels = ((labels > 0) & (labels != input_ids.to(labels))).view(-1)
